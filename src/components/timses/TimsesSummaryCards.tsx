    ...
    <View className="flex-row gap-sm">
      <View className="flex-1 rounded-lg bg-primary p-md">
        {isLoading ? (
          ...
          <Text className="text-headline-md font-semibold text-text-inverse">{total}</Text>
        )}
        <Text className="text-caption text-text-inverse-muted">Total Anggota</Text>
      </View>
      <View className="flex-1 rounded-lg border border-border bg-surface p-md">
        {isLoading ? (
          ...
          <Text className="text-headline-md font-semibold text-success">{online} Online</Text>
        )}
